...
- 编码本建议生成一版本maxqda字典格式，提示语可参考以下形式：
    ...
    | 分类 | 检索词 | 索引起始点 | ID |
    | 编码名字1 ｜ 引文1 | star-end ｜ 用户ID |
	| 编码名字1 ｜ 引文2 ｜ [star, end] ｜ 用户ID |
	| 编码名字1 ｜ 引文N ｜ [star, end] ｜ 用户ID |
	| 编码名字2 ｜ 引文1 | [star, end] ｜ 用户ID |
	| 编码名字2 ｜ 引文2 ｜ [star, end] ｜ 用户ID |
	| 编码名字2 ｜ 引文N ｜ [star, end] ｜ 用户ID |
	| 编码名字N ｜ 引文1 | [star, end] ｜ 用户ID |
	| 编码名字N ｜ 引文2 ｜ [star, end] ｜ 用户ID |
	| 编码名字N ｜ 引文N ｜ [star, end] ｜ 用户ID |
